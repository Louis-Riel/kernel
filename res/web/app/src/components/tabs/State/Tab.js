...
import {wfetch, fromVersionedToPlain, genUUID} from '../../../utils/utils';
import { Button, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
import LocalJSONEditor from '../../controls/JSONEditor';
import FirmwareUpdater from '../../controls/FirmwareUpdater'
import './State.css';
...
export default class StatusPage extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (!this.mounted && prevProps && !prevProps.hasLoaded && this.props.hasLoaded) {
            this.mounted=true;
